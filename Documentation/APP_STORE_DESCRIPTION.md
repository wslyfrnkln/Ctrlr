# Ctrlr - App Store Listing

## App Name
**Ctrlr**

## Subtitle (30 characters max)
`MIDI Controller for Your DAW`
...
The SSL-inspired vertical fader gives you precise control over volume and parameters. Smooth, responsive, and designed for real mixing workflows. Visual VU meters provide instant feedback on your levels.
...
**PERFECT FOR**
- Music producers working in Ableton Live
- Recording engineers who need remote transport control
- Live performers triggering clips and controlling parameters
- Anyone who wants DAW control away from their desk

**PRIVACY FOCUSED**
Ctrlr works entirely on your device. No accounts, no tracking, no data collection. Your music stays yours.
...
- Quick-access macro grid
- Track arm and loop toggles
- MIDI device picker
